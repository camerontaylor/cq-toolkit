...
- package.json of this repository — `"name": "@camerontaylor/cq-toolkit"`, `"version": "1.0.1"` (the post-v1.0.0 patch line; it was `1.0.0` at the v1.0.0 release, and `0.0.0` from the T0.5 placeholder until then — unscoped `cq-toolkit` was the T0.5-era name; see the owner decision above)
