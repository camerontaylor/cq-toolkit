...
| tarball audit              | `npm pack` at audited head `900043a` (packed paths byte-identical to the release SHA `93bbf19`): 273 paths, only `dist/`, `policy/`, `LICENSE`, `README.md`, `package.json`; denylist clean (9 classes); sha256 `699a72dab4e48bacb5b6c59946da5ef701e88883e2bb2e073c5cfd0087ff71c4` | [`docs/release-evidence/pack-audit.log`](release-evidence/pack-audit.log), [PR #200 pack-audit run 35535533866](https://github.com/camerontaylor/cq-toolkit/actions/runs/35535533866) (path-allowlist + denylist; the local log carries the sha256) |
