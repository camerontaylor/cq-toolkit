...
- **Family:** `analyze`
- **CLI:** `cq analyze.renderAnalysisReport [--<schema-key>=<value> ...] [--json]`; run `cq analyze.renderAnalysisReport --help` for the input schema (a secondary interface over the SDK — see [`src/cli/README.md`](../../src/cli/README.md))
