...
- **Family:** `gates`
- **CLI:** `cq gates.policyDiff [--<schema-key>=<value> ...] [--json]`; run `cq gates.policyDiff --help` for the input schema (a secondary interface over the SDK — see [`src/cli/README.md`](../../src/cli/README.md))
