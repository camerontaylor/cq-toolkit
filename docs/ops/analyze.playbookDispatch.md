...
- **Family:** `analyze`
- **CLI:** `cq analyze.playbookDispatch [--<schema-key>=<value> ...] [--json]`; run `cq analyze.playbookDispatch --help` for the input schema (a secondary interface over the SDK — see [`src/cli/README.md`](../../src/cli/README.md))
