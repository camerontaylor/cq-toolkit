...
- **Family:** `ratchet`
- **CLI:** `cq ratchet.proposeBaselineUpdate [--<schema-key>=<value> ...] [--json]`; run `cq ratchet.proposeBaselineUpdate --help` for the input schema (a secondary interface over the SDK — see [`src/cli/README.md`](../../src/cli/README.md))
