...
- **Family:** `analyze`
- **CLI:** `cq analyze.clusterErrors [--<schema-key>=<value> ...] [--json]`; run `cq analyze.clusterErrors --help` for the input schema (a secondary interface over the SDK — see [`src/cli/README.md`](../../src/cli/README.md))
