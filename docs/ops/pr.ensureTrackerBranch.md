...
- **Family:** `pr`
- **CLI:** `cq pr.ensureTrackerBranch [--<schema-key>=<value> ...] [--json]`; run `cq pr.ensureTrackerBranch --help` for the input schema (a secondary interface over the SDK — see [`src/cli/README.md`](../../src/cli/README.md))
