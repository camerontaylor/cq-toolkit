...
- **Family:** `sweep`
- **CLI:** `cq sweep.planSweep [--<schema-key>=<value> ...] [--json]`; run `cq sweep.planSweep --help` for the input schema (a secondary interface over the SDK — see [`src/cli/README.md`](../../src/cli/README.md))
