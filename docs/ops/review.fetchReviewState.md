...
- **Family:** `review`
- **CLI:** `cq review.fetchReviewState [--<schema-key>=<value> ...] [--json]`; run `cq review.fetchReviewState --help` for the input schema (a secondary interface over the SDK — see [`src/cli/README.md`](../../src/cli/README.md))
