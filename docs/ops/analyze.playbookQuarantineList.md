...
- **Family:** `analyze`
- **CLI:** `cq analyze.playbookQuarantineList [--<schema-key>=<value> ...] [--json]`; run `cq analyze.playbookQuarantineList --help` for the input schema (a secondary interface over the SDK — see [`src/cli/README.md`](../../src/cli/README.md))
