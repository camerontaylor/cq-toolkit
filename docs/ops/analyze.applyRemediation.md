...
- **Family:** `analyze`
- **CLI:** `cq analyze.applyRemediation [--<schema-key>=<value> ...] [--json]`; run `cq analyze.applyRemediation --help` for the input schema (a secondary interface over the SDK — see [`src/cli/README.md`](../../src/cli/README.md))
