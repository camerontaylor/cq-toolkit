...
- **Family:** `pr`
- **CLI:** `cq pr.runReport [--<schema-key>=<value> ...] [--json]`; run `cq pr.runReport --help` for the input schema (a secondary interface over the SDK — see [`src/cli/README.md`](../../src/cli/README.md))
