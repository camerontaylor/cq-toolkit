...
- **Family:** `merge`
- **CLI:** `cq merge.planMergeOrder [--<schema-key>=<value> ...] [--json]`; run `cq merge.planMergeOrder --help` for the input schema (a secondary interface over the SDK — see [`src/cli/README.md`](../../src/cli/README.md))
