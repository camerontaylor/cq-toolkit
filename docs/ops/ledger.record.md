...
- **Family:** `ledger`
- **CLI:** `cq ledger.record [--<schema-key>=<value> ...] [--json]`; run `cq ledger.record --help` for the input schema (a secondary interface over the SDK — see [`src/cli/README.md`](../../src/cli/README.md))
