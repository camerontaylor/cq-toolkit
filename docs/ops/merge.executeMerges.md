...
- **Family:** `merge`
- **CLI:** `cq merge.executeMerges [--<schema-key>=<value> ...] [--json]`; run `cq merge.executeMerges --help` for the input schema (a secondary interface over the SDK — see [`src/cli/README.md`](../../src/cli/README.md))
