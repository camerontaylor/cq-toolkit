...
- **Family:** `merge`
- **CLI:** `cq merge.runPrs [--<schema-key>=<value> ...] [--json]`; run `cq merge.runPrs --help` for the input schema (a secondary interface over the SDK — see [`src/cli/README.md`](../../src/cli/README.md))
