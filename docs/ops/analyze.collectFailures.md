...
- **Family:** `analyze`
- **CLI:** `cq analyze.collectFailures [--<schema-key>=<value> ...] [--json]`; run `cq analyze.collectFailures --help` for the input schema (a secondary interface over the SDK — see [`src/cli/README.md`](../../src/cli/README.md))
