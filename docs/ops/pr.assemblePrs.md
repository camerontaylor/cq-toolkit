...
- **Family:** `pr`
- **CLI:** `cq pr.assemblePrs [--<schema-key>=<value> ...] [--json]`; run `cq pr.assemblePrs --help` for the input schema (a secondary interface over the SDK — see [`src/cli/README.md`](../../src/cli/README.md))
