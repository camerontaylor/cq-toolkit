...
- **Family:** `gates`
- **CLI:** `cq gates.checkRunner [--<schema-key>=<value> ...] [--json]`; run `cq gates.checkRunner --help` for the input schema (a secondary interface over the SDK — see [`src/cli/README.md`](../../src/cli/README.md))
