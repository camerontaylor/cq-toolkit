...
| evidence                                                                 | link                                                                                                                                                                                                                                                                                                                                                                                                    |
| ------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| only-tightening baseline PR opened via `proposeBaselineUpdate` (93 → 94) | [PR #198](https://github.com/camerontaylor/cq-toolkit/pull/198) · [ratchet run 35527034882](https://github.com/camerontaylor/cq-toolkit/actions/runs/35527034882) (all required checks green) — **MERGED through the protocol → `0d76ed5b410b413309d33e4d4e11eaee146db099`, ff-promoted to `main`** ([promotion run 35527938976](https://github.com/camerontaylor/cq-toolkit/actions/runs/35527938976)) |
...
| ------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [#198](https://github.com/camerontaylor/cq-toolkit/pull/198) | all required checks green (`static` ×2, `denylist` ×2, `ratchet` ×2, `from-source` ×2, `pack-audit`, `build+test` ×2) | no `[automation]` prefix / `cq-automation` label — the shipped op does not set the convention yet; **merged through the protocol → `0d76ed5b410b413309d33e4d4e11eaee146db099`** |
...
| [#198](https://github.com/camerontaylor/cq-toolkit/pull/198)        | `0d76ed5b410b413309d33e4d4e11eaee146db099` | 2026-09-20 | `single-identity I2 awaiting` (automation-authored ratchet proposal) | `gh pr checks 198`: all required checks green; fresh review + audit PASS                                                                            |
